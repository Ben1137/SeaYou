...
import { Coordinate, PointForecast, DetailedPointForecast } from '../types';
import { Trash2, Navigation, MapPin, Wind, Layers, Waves, X, Clock, Activity, Droplets } from 'lucide-react';
import { fetchPointForecast, fetchHourlyPointForecast, fetchBulkPointForecast } from '../services/weatherService';
