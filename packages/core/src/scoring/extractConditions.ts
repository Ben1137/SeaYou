...
export function extractHourlyConditions(
  ...
  return {
    ...
    secondarySwellHeight: h.secondary_swell_wave_height?.[hourIndex] ?? undefined,
    secondarySwellPeriod: h.secondary_swell_wave_period?.[hourIndex] ?? undefined,
    secondarySwellDirection: h.secondary_swell_wave_direction?.[hourIndex] ?? undefined,
