...
- **`vite.config.ts`** - Build configuration with `base: '/SeaYou/'`
...
1. Go to: [https://github.com/Ben1137/SeaYou/actions](https://github.com/Ben1137/SeaYou/actions)
...
1. Go to [Actions tab](https://github.com/Ben1137/SeaYou/actions)
...
2. Check [Actions tab](https://github.com/Ben1137/SeaYou/actions) for green checkmark
3. Visit [https://ben1137.github.io/SeaYou/](https://ben1137.github.io/SeaYou/)
...
- `vite.config.ts` has `base: '/SeaYou/'`
...
Share this link with friends: **https://ben1137.github.io/SeaYou/**
...
Your SeaYou app is fully configured for automatic deployment. Just push to `main` and your changes go live automatically!
