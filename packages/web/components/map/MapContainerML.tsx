...
import { CustomCompassControl } from './controls/CustomCompassControl';
...
export function MapContainerML({ currentLocation, tsunamiRisks = [], favoriteLocations = [], tides }: MapContainerMLProps) {
  ...
  useEffect(() => {
    ...
    map.addControl(new CustomCompassControl(), 'bottom-right');
    map.addControl(
        ...
        >
          <div className="space-y-1 p-2">
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'NONE' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'WIND' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
              <Wind size={12} /> {t('map.wind')}
            </button>
            <button
              onClick={() => selectBaseLayer('WAVE')}
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'WAVE' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
              <Waves size={12} /> {t('map.sigWaves')}
            </button>
            <button
              onClick={() => selectBaseLayer('WIND_WAVE')}
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'WIND_WAVE' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
              <Waves size={12} /> {t('map.windWaves')}
            </button>
            <button
              onClick={() => selectBaseLayer('SWELL')}
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'SWELL' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
              <Waves size={12} /> {t('weather.swell')}
            </button>
            <button
              onClick={() => selectBaseLayer('CURRENTS')}
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${activeLayer === 'CURRENTS' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'WIND_PARTICLES' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'CURRENT_PARTICLES' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'CURRENT_HEATMAP' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'WAVE_HEATMAP' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'SEA_TEMP' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'SEA_TEMP_CURRENTS' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'SEA_TEMP_WIND' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'AIR_TEMP' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'PRECIPITATION' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'CLOUD_COVER' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
                ...
                <>
                  ...
                  {relevant.includes('SWELL_PARTICLES') && (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'SWELL_PARTICLES' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
                    >
                  ...
                  {relevant.includes('DIVE_SUITABILITY') && (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'DIVE_SUITABILITY' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
                    >
                  ...
                  {relevant.includes('CHOP_LEVEL') && (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'CHOP_LEVEL' ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
                    >
                  ...
                  {relevant.includes('GUST_DELTA') && (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${advancedLayer === 'GUST_DELTA' ? 'bg-amber-600 text-white' : 'text-white/40 hover:bg-white/10'}`}
                    >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.coastline ? 'bg-cyan-700 text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.bathymetry ? 'bg-blue-700 text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
              <Droplets size={12} /> <span className="flex-1">{t('map.bathymetry', 'Bathymetry')}</span>
            </button>
            <button
              onClick={() => tryToggleOverlay('reefs')}
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.reefs ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.ports ? 'bg-amber-600 text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.marineAreas ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.radar ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.enc ? 'bg-rose-600 text-white' : 'text-white/40 hover:bg-white/10'}`}
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.noaaEnc ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${geoJSONLayers.linz ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
            ...
            <button
              ...
              className={`w-full text-left px-3 py-3 rounded flex items-center gap-2 transition-colors ${aisVisible ? 'bg-[var(--bg-button)] text-white' : 'text-white/40 hover:bg-white/10'}`}
